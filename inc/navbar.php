...
<a href="home.php" style="text-decoration: none;"><div class='social-btn flex-center' id="button">
    ...
    <div class="main">
            ...
            <div class="tweet-box tweet-add">
                <div class="tweet-body">
                    <form method="post" enctype="multipart/form-data">
                        <textarea name="post_text" id="" cols="100%" rows="3" placeholder="Typ je bericht hier..."></textarea>

                        <div class="tweet-icons-wrapper">

                            <button class="logout" type="submit" name="btn-add-post">Verzend</button>
